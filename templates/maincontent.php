<div id="sidebar" class="sidebar leaflet-sidebar">
	<div class="sidebar-tabs leaflet-sidebar-tabs">
		<!-- Nav tabs -->
	...
	<!-- Tab panes -->
	<div class="sidebar-content leaflet-sidebar-content">
		<div class="sidebar-pane leaflet-sidebar-pane active" id="ho">
			<div id="logofolder">
				<div id="logo"></div>
				<p class="version">v
					<?php
			...
			<div id="options">
				...
				<div id="optionscontent" style="display:none;">
					<div id="optioncheckdiv">
						...
						<br/>
						<div class="checkboxes">
							<input id="exportoneperdev" class="checkbox" type="checkbox"/>
		...
		<div class="sidebar-pane leaflet-sidebar-pane" id="phonetrackfilters">
			<div id="filterDiv">
				...
				<table id="filterPointsTable">
					<tr>
						<td>
							<input class="checkbox" type="checkbox" id="applyfilters"/>
		...
		<div class="sidebar-pane leaflet-sidebar-pane" id="phonetrackstats">
		...
		<div class="sidebar-pane leaflet-sidebar-pane" id="help">
